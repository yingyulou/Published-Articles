...
void memoryInit()
{
    ...
    bitmapInit(&__vMemoryBitmap, (uint8_t *)0xc009d000, 0x8000, true);
}
...
{
    return (void *)__allocatePage(&__vMemoryBitmap, &__pMemoryBitmap, pageCount, 0xc0100000, 0x200000);
}
...
{
    __deallocatePage((uint32_t)vAddr, &__vMemoryBitmap, &__pMemoryBitmap, pageCount, 0xc0100000, 0x200000);
}
